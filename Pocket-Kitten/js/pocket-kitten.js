...
document.getElementsByTagName('figure')[0].addEventListener('click', function onKittenSmashed(evt) {
  setImage(lightValue);
});
document.getElementsByTagName('figure')[0].addEventListener('touchstart', function onKittenSmashed(evt) {
  setImage(lightValue);
});
